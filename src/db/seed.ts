...
export const SEED_EXERCISES: CatalogueEntry[] = [
  // ── Chest ────────────────────────────────────────────────────────────────
  e("Barbell Bench Press", "strength", "barbell", [
    "chest",
    "triceps",
    "shoulders",
  ]),
  e("Barbell Incline Bench Press", "strength", "barbell", [
    "chest",
    "shoulders",
    "triceps",
  ]),
  e("Barbell Close-Grip Bench Press", "strength", "barbell", [
    "triceps",
    "chest",
    "shoulders",
  ]),
  e("Dumbbell Bench Press", "strength", "dumbbell", [
    "chest",
    "triceps",
    "shoulders",
  ]),
  e("Dumbbell Incline Bench Press", "strength", "dumbbell", [
    "chest",
    "shoulders",
    "triceps",
  ]),
  ...
  e("Machine Chest Press", "strength", "machine", [
    "chest",
    "triceps",
    "shoulders",
  ]),
  ...
  e("Chest-Supported Dumbbell Row", "strength", "dumbbell", [
    "back",
    "rear-delts",
    "lats",
  ]),
  ...
  e("Back Extension", "strength", "bodyweight", [
    "lower-back",
    "glutes",
    "hamstrings",
  ]),
  ...
  e("Seated Dumbbell Shoulder Press", "strength", "dumbbell", [
    "shoulders",
    "triceps",
  ]),
  ...
  e("Bulgarian Split Squat", "strength", "dumbbell", [
    "quads",
    "glutes",
    "adductors",
  ]),
  ...
  // ── Hamstrings & glutes ──────────────────────────────────────────────────
  e("Romanian Deadlift", "strength", "barbell", [
    "hamstrings",
    "glutes",
    "lower-back",
  ]),
  e("Dumbbell Romanian Deadlift", "strength", "dumbbell", [
    "hamstrings",
    "glutes",
  ]),
  e("Stiff-Leg Deadlift", "strength", "barbell", [
    "hamstrings",
    "lower-back",
    "glutes",
  ]),
  e("Sumo Deadlift", "strength", "barbell", [
    "glutes",
    "quads",
    "adductors",
    "lower-back",
  ...
  e("Good Morning", "strength", "barbell", [
    "hamstrings",
    "lower-back",
    "glutes",
  ]),
  ...
  e(
    ...
    "bodyweight",
    ["core"],
    "Log seconds held as reps, or track as cardio-style duration.",
  ),
  ...
  e("Treadmill Run", "cardio", "treadmill", [
    "cardiovascular",
    "quads",
    "calves",
  ]),
  e("Cycling (Outdoor)", "cardio", "bicycle", [
    "cardiovascular",
    "quads",
    "glutes",
  ]),
  e("Indoor Bike", "cardio", "stationary bike", [
    "cardiovascular",
    "quads",
    "glutes",
  ]),
  e("Rowing Machine", "cardio", "rower", [
    "cardiovascular",
    "back",
    "quads",
    "lats",
  ]),
  e("Elliptical", "cardio", "elliptical", [
    "cardiovascular",
    "quads",
    "glutes",
  ]),
  e("Stair Climber", "cardio", "stair climber", [
    "cardiovascular",
    "glutes",
    "quads",
    "calves",
  ]),
  e("Swimming", "cardio", "pool", [
    "cardiovascular",
    "lats",
    "shoulders",
    "full-body",
  ]),
  e("Jump Rope", "cardio", "jump rope", [
    "cardiovascular",
    "calves",
    "shoulders",
  ]),
  e("Ruck", "cardio", "weighted pack", [
    "cardiovascular",
    "quads",
    "glutes",
    "lower-back",
  ]),
  e("Incline Treadmill Walk", "cardio", "treadmill", [
    "cardiovascular",
    "glutes",
    "calves",
  ]),
  ...
  e("Kettlebell Swing", "strength", "kettlebell", [
    "glutes",
    "hamstrings",
    "core",
  ]),
  ...
  e(
    ...
    "strength",
    "kettlebell",
    ["glutes", "hamstrings", "shoulders", "traps"],
    undefined,
    2,
  ),
  e(
...
export async function seedDatabase(database: WorkoutDB): Promise<void> {
  // One transaction over both tables, so the read that decides what is missing
  // and the write that inserts it cannot be interleaved with another caller.
  // Without this, two seeds racing each other both observe an empty table and
  // both insert the catalogue — React StrictMode double-invokes the effect in
  // development, and in production two open tabs do the same thing.
  await database.transaction(
    ...
    async () => {
      ...
      const existingNames = new Set(
        existingExercises.map((ex) => ex.name.trim().toLowerCase()),
      );
      const candidates = SEED_EXERCISES.filter(
        (ex) =>
          ex.addedIn >= minAddedIn &&
      ...
      if (candidates.length > 0) {
        ...
        await database.exercises.bulkAdd(
          candidates.map((ex) => toExerciseRow(ex, stamp)),
        );
      }
      ...
      const swing = existingExercises.find(
        (ex) =>
          !ex.isCustom &&
          ex.name === "Kettlebell Swing" &&
          ex.modality === "other",
      );
      if (swing) {
        await database.exercises.update(swing.id, {
          modality: "strength",
          updatedAt: now(),
        });
      }
